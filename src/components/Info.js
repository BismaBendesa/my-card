...
import heroImg from "./../assets/img/bapakbapak2.png";
import heroImg2 from "./../assets/img/Bapak bapak 1.png";

export default function Info(props) {
  let ImgChooser = props.name;
  return (
    <div className="info-container">
      <img
        src={ImgChooser === "1" ? heroImg : heroImg2}
        alt="hero-img"
        class="hero-img"
      />
      <h1 className="username">Bisma Bendesa</h1>
      <p className="role">Frontend Developer</p>
      <p className="website">bismabendesa.github.io</p>
      <div className="cta">
